...
public static class Resources
{
    ...
    public static string CheckNewVersion => GetString(nameof(CheckNewVersion));
    public static string CheckUpdateNotes => GetString(nameof(CheckUpdateNotes));
    public static string InstallNewVersion => GetString(nameof(InstallNewVersion));
    public static string InstallNewVersionUnknownVersion => GetString(nameof(InstallNewVersionUnknownVersion));
    public static string NewVersionAvailable => GetString(nameof(NewVersionAvailable));
    public static string NewVersionAvailableUnknownVersion => GetString(nameof(NewVersionAvailableUnknownVersion));
    public static string UpdateAvailableMessage => GetString(nameof(UpdateAvailableMessage));
    public static string UpdateAvailableMessageUnknownVersion => GetString(nameof(UpdateAvailableMessageUnknownVersion));
    ...
    public static string UpdateReleaseNotesOpenFailed => GetString(nameof(UpdateReleaseNotesOpenFailed));
