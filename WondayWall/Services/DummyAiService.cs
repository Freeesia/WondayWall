...
#if DEBUG
// デバッグビルドでのみ有効なダミーAIサービス。リリースビルドには含めない。
public class DummyAiService(AppConfigService configService, DummyNewsGenerator dummyNewsGenerator) : IAiService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var news = dummyNewsGenerator.BuildNewsTopics();
